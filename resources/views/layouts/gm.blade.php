        ...
        <div class="flex-col bg-white rounded-md dark:bg-darker border dark:border-primary">
            ...
            <div class="flex align-middle items-center">
                <div class="flex flex-col mx-2 my-2 w-full rounded" role="alert">
                    <a class="font-bold" href="https://www.facebook.com/zhuxian.AOC" target="_blank">
                        ...
                        <br>
                        <svg style="display:inline" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 50 50">
