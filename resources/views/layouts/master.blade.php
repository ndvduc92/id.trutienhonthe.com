...
<div x-data="{ isActive: false, open: false }">
    ...
    <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Shop">
        ...
        <a
            href="http://localhost:9000/dashboard/shop"
            role="menuitem"
        ...
        <a
            href="http://localhost:9000/dashboard/shop/mask/1"
            role="menuitem"
            class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
        >
            Weapons
        ...
        <div x-data="{ isActive: false, open: false }">
            ...
            <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Equipment">
                ...
                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                <a
                    href="http://localhost:9000/dashboard/shop/mask/2"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Helmet
                ...
                <a
                    href="http://localhost:9000/dashboard/shop/mask/256"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Arms
                ...
                <a
                    href="http://localhost:9000/dashboard/shop/mask/16"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Chest
                ...
                <a
                    href="http://localhost:9000/dashboard/shop/mask/8"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Robe
                ...
                <a
                    href="http://localhost:9000/dashboard/shop/mask/64"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Leg
                ...
                <a
                    href="http://localhost:9000/dashboard/shop/mask/128"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Feet
        ...
        <div x-data="{ isActive: false, open: false }">
            ...
            <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Equipment">
                ...
                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                <a
                    href="http://localhost:9000/dashboard/shop/mask/65536"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Arms
                ...
                <a
                    href="http://localhost:9000/dashboard/shop/mask/8192"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Chest
                ...
                <a
                    href="http://localhost:9000/dashboard/shop/mask/16384"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Leg
                ...
                <a
                    href="http://localhost:9000/dashboard/shop/mask/32768"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Feet
        ...
        <div x-data="{ isActive: false, open: false }">
            ...
            <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Equipment">
                ...
                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                <a
                    href="http://localhost:9000/dashboard/shop/mask/1536"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Ring
                ...
                <a
                    href="http://localhost:9000/dashboard/shop/mask/32"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Belt
                ...
                <a
                    href="http://localhost:9000/dashboard/shop/mask/4"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    Necklace
        ...
        <div x-data="{ isActive: false, open: false }">
            ...
            <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Charms">
                ...
                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                <a
                    href="http://localhost:9000/dashboard/shop/mask/1048576"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    HP
                ...
                <a
                    href="http://localhost:9000/dashboard/shop/mask/2097152"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                >
                    MP
        ...
        <a
            href="http://localhost:9000/dashboard/shop/mask/262144"
            role="menuitem"
            class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
        >
            Heaven Book/Tome
        ...
        <a
            href="http://localhost:9000/dashboard/shop/mask/524288"
            role="menuitem"
            class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
        >
            Chat Smiley
        ...
        <a
            href="http://localhost:9000/dashboard/shop/mask/4096"
            role="menuitem"
            class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
        >
            Flying Mount
        ...
        <a
            href="http://localhost:9000/dashboard/shop/mask/0"
            role="menuitem"
            class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
        >
            Other
...
<div x-data="{ isActive: false, open: false }">
    ...
    <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="TopUp">
        ...
        <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                        <a
            href="http://localhost:9000/dashboard/donate/history"
            role="menuitem"
            class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
        >
            Transaction History
...
<div x-data="{ isActive: false, open: false }">
    <!-- active & hover classes 'bg-primary-100 dark:bg-primary' -->
    <a
        href="http://localhost:9000/dashboard/vote"
        class="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-primary-100 dark:hover:bg-primary"
        :class="{'bg-primary-100 dark:bg-primary': isActive || open}"
        role="button"
        aria-haspopup="true"
...
<div x-data="{ isActive: false, open: false }">
    <!-- active & hover classes 'bg-primary-100 dark:bg-primary' -->
    <a
        href="http://localhost:9000/dashboard/services"
        class="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-primary-100 dark:hover:bg-primary"
        :class="{'bg-primary-100 dark:bg-primary': isActive || open}"
        role="button"
        aria-haspopup="true"
...
<div x-data="{ isActive: false, open: false }">
    ...
    <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Ranking">
        ...
        <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
        <a
            href="http://localhost:9000/dashboard/ranking/player/level"
            role="menuitem"
            class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
        >
            Players Rank
        ...
        <a
            href="http://localhost:9000/dashboard/ranking/faction/level"
            role="menuitem"
            class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
        >
            Faction Rank
    ...
    >
            ...
            >
                <img class="inline-flex"
                     src="http://localhost:9000/img/flags/en.png" alt=""/> English
            </a>
                    <a role="menuitem" href="http://localhost:9000/dashboard?language=vn"
               class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary"
            >
                <img class="inline-flex"
                     src="http://localhost:9000/img/flags/vn.png" alt=""/> Việt Nam
            </a>
            </div>
</div>
                        <div class="relative" x-data="{ open: false }">
...
<div class="relative" x-data="{ open: false }" @click.away="open = false" @close.stop="open = false">
    <button @click="open = !open; $nextTick(() => { if(open){ $refs.userMenu.focus() } })"
        ...
        <img class="w-10 h-10 rounded-full" src="https://ui-avatars.com/api/?name=h&amp;color=7F9CF5&amp;background=EBF4FF"
                 alt="haz1"/>
    </button>
    ...
    >
        <a class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary" role="menuitem" href="http://localhost:9000/user/profile">Profile</a>
        <a class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary" role="menuitem" href="http://localhost:9000/dashboard/donate/history">Transaction History</a>
                <form method="POST" action="http://localhost:9000/logout">
            <input type="hidden" name="_token" value="HVG6814FIcyJTCy07iujNAKPrsNv4gJ18Xg6Ourt">            <a class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary" role="menuitem" href="http://localhost:9000/logout" onclick="event.preventDefault();
...
<div class="relative ml-auto" x-data="{ open: false }">
    ...
    <div
        ...
        aria-label="Language menu"
    >
                    <a href="http://localhost:9000/dashboard?language=langen"
               role="menuitem"
               class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary"
            >
                <img class="inline-flex"
                     src="http://localhost:9000/img/flags/langen.png" alt=""/> language.langen
            </a>
                    <a href="http://localhost:9000/dashboard?language=langvn"
               role="menuitem"
               class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary"
            >
                <img class="inline-flex"
                     src="http://localhost:9000/img/flags/langvn.png" alt=""/> language.langvn
            </a>
            </div>
</div>
                        <div class="relative" x-data="{ open: false }">
...
<hr>
        <a
            href="http://localhost:9000/user/profile"
            role="menuitem"
            class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary"
        >
            Profile
        ...
        >
            Transaction History
                ...
                <form method="POST" action="http://localhost:9000/logout">
            <input type="hidden" name="_token" value="HVG6814FIcyJTCy07iujNAKPrsNv4gJ18Xg6Ourt">            <a
    ...
    <div class="flex flex-col bg-white rounded-md dark:bg-darker border dark:border-primary">
        <div class="flex align-middle items-center justify-between p-2">
            <div>
                ...
                <span
                    class="text-sm font-semibold">12 October, 2024 05:29 pm</span>
            </div>
        </div>
        <div class="flex align-middle items-center justify-between p-2">
            <div>
                ...
                <span class="text-xl font-semibold"><a href="https://wa.me/62879456123"
        ...
        <div class="flex align-middle items-center justify-between p-2">
            <div>
                <span class="text-xl font-semibold"><a href="link here"
                                                       target="_blank"><img src="http://localhost:9000/img/discordlogo.png"
...
>
    <div>Copyright © <span id="get-current-year"></span> <a href="http://localhost:9000" target="_blank"
...
<script data-turbo-eval="false" data-turbolinks-eval="false" >
    ...
    window.livewire_token = 'HVG6814FIcyJTCy07iujNAKPrsNv4gJ18Xg6Ourt';
...
<script src="http://localhost:9000/js/kamona-wd.js"></script>
<script>
    const setup = () => {
        const getTheme = () => {
